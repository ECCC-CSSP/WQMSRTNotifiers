...
namespace WQMS.RTNotifiers
{
    public class RTStationMonitor
    {
        ...
        {
            //string EmailAddresses = "david.benoit@ec.gc.ca";
        ...
        public void SendEmail(string message, DataTable dtContacts)
        {
            ...
            //string frEmailAddress = "david.benoit@ec.gc.ca";
            ...
            foreach (DataRow row in dtContacts.Rows)
            {
                ...
                //if (emailAddress == "david.benoit@ec.gc.ca" || emailAddress == "genevieve.tardif@ec.gc.ca" || emailAddress == "christine.garron@ec.gc.ca")
                //{
            ...
            //mail.CC.Add("christine.garron@ec.gc.ca");
